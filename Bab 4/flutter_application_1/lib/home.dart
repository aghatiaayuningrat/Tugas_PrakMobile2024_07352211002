      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const ServiceList(),
            SectionTitle(title: "Best Order", onViewAll: () {}),
            const BestBooking(),
            const BestBooking2(),
            SectionTitle(title: "Recommended Menu", onViewAll: () {}),
            const RecommendedWorkshopsPage(),
            SectionTitle(title: "Profile", onViewAll: () {}),
            Profil(),
          ],
        ),
      ),
      ...
      child: ListView(
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context);
              // Tambahkan logika keluar aplikasi
            },
          ),
        ],
      ),
...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    {
      "name": "Mie Telur",
      "profession": "Mie + Telur",
      "rating": 4.8,
      "image": "images/telur.jpg"
    },
    {
      "name": "Mie Ceker",
      "profession": "Mie + Ceker",
      "rating": 4.5,
      "image": "images/ceker.jpg"
    },
    {
      "name": "Mie Bakso",
      "profession": "Mie + Bakso",
      "rating": 4.9,
...
class BestBooking2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        BestBookingCard(
          imageUrl: 'images/ceker.jpg',
          profileUrl: 'images/ceker.jpg',
          name: 'Mie Ayam Ceker',
          role: 'Mie + Ceker',
          description: 'Mie Ayam dengan toping ceker',
          rating: 4.5,
        ),
        SizedBox(height: 16.0),
        BestBookingCard(
          imageUrl: 'images/bakso.jpg',
          profileUrl: 'images/bakso.jpg',
          name: 'Mie Ayam Bakso',
          role: 'Mie + Bakso',
          description: 'Mie Ayam dengan toping bakso',
          rating: 4.9,
